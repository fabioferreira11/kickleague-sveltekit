	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/check-email/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/checkIfPackOpened/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/checkPackStatus/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getPlayerPack/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getPlayersCompo/_server.js'))
			},
			{
				id: "/api/getUserId",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getUserId/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/getUserPlayers/_server.js'))
			},
			{
				id: "/api/login",
				pattern: /^\/api\/login\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/openPack/_server.js'))
			},
			{
				id: "/api/players",
				pattern: /^\/api\/players\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/session/_server.js'))
			},
			{
				id: "/api/updateclub",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/updateclub/_server.js'))
			},
			{
				id: "/api/updatepays",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/updatepays/_server.js'))
			},
			{
				id: "/choixclub",
				pattern: /^\/choixclub\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/register/_server.js'))
			},
			{
				id: "/tournoi",
				pattern: /^\/tournoi\/?$/,
