...
return {
	...
	_: {
		client: {"start":"_app/immutable/entry/start.DMt4Gmxo.js","app":"_app/immutable/entry/app.Bq9id3Op.js","imports":["_app/immutable/entry/start.DMt4Gmxo.js","_app/immutable/chunks/entry.DXWqRFhg.js","_app/immutable/chunks/scheduler.RIs2sDzR.js","_app/immutable/entry/app.Bq9id3Op.js","_app/immutable/chunks/preload-helper.D6kgxu3v.js","_app/immutable/chunks/scheduler.RIs2sDzR.js","_app/immutable/chunks/index.CgKjrO5Z.js"],"stylesheets":[],"fonts":[],"uses_env_dynamic_public":false},
		nodes: [
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/check-email/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/checkIfPackOpened/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/checkPackStatus/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/getPlayerPack/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/getPlayersCompo/_server.js'))
			},
			{
				id: "/api/getUserId",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/getUserId/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/getUserPlayers/_server.js'))
			},
			{
				id: "/api/login",
				pattern: /^\/api\/login\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/openPack/_server.js'))
			},
			{
				id: "/api/players",
				pattern: /^\/api\/players\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/players/_server.js'))
			},
			{
				id: "/api/session",
				pattern: /^\/api\/session\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/session/_server.js'))
			},
			{
				id: "/api/updateclub",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/updateclub/_server.js'))
			},
			{
				id: "/api/updatepays",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/updatepays/_server.js'))
			},
			{
				id: "/choixclub",
				pattern: /^\/choixclub\/?$/,
